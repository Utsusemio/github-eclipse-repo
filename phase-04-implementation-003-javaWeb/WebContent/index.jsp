...
<body class="background1">
	<audio id="intr" controls="controls"
		src="/static/audio/bgm01.mp3" autoplay="autoplay"></audio>
	<audio id="poem" src="/static/audio/wanderingEarch-poem.mp3"
		preload="auto"></audio>
    <span id="firstline" style="font-size: 22px; color: white">大家好，我是叶峻杰，下面是我是设计的“<span
		style="font-size: 38px; color: red">流浪地球</span>”的模拟工程！ 欢迎大家观赏,谢谢！点击屏幕右下角的地球，可以开始悲壮的流浪！！
	</span>
	<audio id="waiting" src="/static/audio/bgm02.mp3" preload="auto" onended="onWaitingAudioEnd();"></audio>
	<div id="poem-txt"
		...
		《诗词版"流浪地球"》<br /> <span style="font-size: 18px; color: grey">
			-叶峻杰 </span><br /> <br /> 西风吹皱东方河，万年地球白发多。 <br /> 流浪星际家何去，满船清梦出银河。
	</div>
